...
router
    .post('/',AuthGuard,RolesGuard(Roles.SUPERADMIN,Roles.ADMIN,Roles.SALLER),validate(product.create),controller.createProduct)
    ...
    .patch('/:id',AuthGuard,RolesGuard(Roles.SUPERADMIN,Roles.ADMIN,Roles.SALLER),validate(product.update),controller.updateProduct)
